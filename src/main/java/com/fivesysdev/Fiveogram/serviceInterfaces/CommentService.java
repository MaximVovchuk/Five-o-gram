...
public interface CommentService {
    ...
    ResponseEntity<Comment> editComment(long id, String text) throws PostNotFoundException;

    ResponseEntity<Post> deleteComment(long id) throws PostNotFoundException;
